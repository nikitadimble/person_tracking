                ...
                <DropdownToggle tag="button" type="button" className="btn">
                    <span className="d-flex align-items-center">
                        ...
                        <span className="text-start ms-xl-2">
                            <span className="d-none d-xl-inline-block ms-1 fw-medium user-name-text">Arinoz</span>
                            <span className="d-none d-xl-block ms-1 fs-12 text-muted user-name-sub-text">Officer</span>
                        </span>
                    </span>
                </DropdownToggle>
