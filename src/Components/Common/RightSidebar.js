                    ...
                    <OffcanvasBody className="p-0">
                        <SimpleBar className="h-100">
                            <div className="p-4">
                                    ...
                                    <div className="col-4">
                                        <div className="form-check card-radio">
                                              <input
                                                ...
                                                onChange={() => dispatch(changeLayout(layoutTypes.VERTICAL))}
                                ...
                                {layoutType === layoutTypes.vertical && <div id="sidebar-visibility">
                                ...
                                {(layoutType === "vertical" || (layoutType === "vertical" && sidebarVisibilitytype === "show")) && (
                                    <React.Fragment>
                                        ...
                                        {layoutType !== "vertical" && (<div id="sidebar-view">
                                ...
                                {(layoutType === "vertical" || layoutType === "twocolumn" || (layoutType === "vertical" && sidebarVisibilitytype === "show")) && (
                                    <React.Fragment>
