    ...
    return (
        <React.Fragment>
            ...
            <div className='page-content'>
                <Container fluid>
                    <BreadCrumb title="Add New Zone" pageTitle="Zone Report" />

                    <Row>
                        <Col lg={12}>
                            <Card>
                                <PreviewCardHeader title="Zone Form" reportName="Zone Report" url="/zoneReport"/>
                                ...
                                <CardBody className='card-body'>
                                    <div className='live-preview'>
                                        <Row className='gy-4'>
                                            ...
                                            <Col xxl={4} md={6}>
                                                <div>
                                                    <Label htmlFor='jail_name' className='form-label'>Zone Name</Label>
                                                    <input type='text' className='form-control' id='jail_name' placeholder='Enter Zone Name'></input>
                                                </div>
                                            </Col>
