    ...
    return (
        <React.Fragment>
            ...
            <div className='page-content'>
                <Container fluid>
                    <BreadCrumb title="Add New District" pageTitle="District Report" />

                    <Row>
                        <Col lg={12}>
                            <Card>
                                <PreviewCardHeader title="District Form" reportName="District Report" url="/districtReport"/>
                                ...
                                <CardBody className='card-body'>
                                    <div className='live-preview'>
                                        <Row className='gy-4'>
                                            ...
                                            <Col xxl={4} md={6}>
                                                <div>
                                                    <Label htmlFor='jail_name' className='form-label'>District Name</Label>
                                                    <input type='text' className='form-control' id='jail_name' placeholder='Enter District Name'></input>
                                                </div>
                                            </Col>
